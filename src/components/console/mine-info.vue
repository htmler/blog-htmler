            ...
            <Col span="11">
                <Card>
                    ...
                    <Row type="flex" justify="space-between">
                        ...
                        <Col span="11">
                            <div>
                                <i-circle :percent="100-percentage" :size="200" :trail-width="4" :stroke-width="5" stroke-linecap="square" stroke-color="#43a3fb">
...
export default {
  ...
  methods: {
    init () {
      this.$server.getSystemInfo('/api/system').then(res => {
        let { constants, release, platform, hostname, type, freemem, totalmem, percentage, cpu } = res;
